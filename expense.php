	...
	<div class="container-fluid p-0" id="containerExpense" >
			...
			<div class="collapse navbar-collapse " id="menu">
				<ul class="navbar-nav m-auto ">
					...
					<li class="nav-item active">
						<a class="nav-link" href="expense.html"><i class="icon-shopping-basket"></i> Dodaj wydatek<span class="sr-only">(current)</span></a>
					</li>
		...
		<div class="row pb-5 justify-content-center addDataRow mx-0">
			...
			<div class="col-12 col-sm-10 col-md-8 col-lg-6 containerAddData">
				<form class="formAddData">
					<h3>Wprowadź wydatek</h3>
					<div class="input-group ">
						<input type="number" class="form-control" placeholder="Kwota" required>
					...
					<div class="input-group ">	
						<input type="date" class="form-control" id="date" placeholder="Data" required>
						<div class="input-group-prepend">
					...
					<div class="input-group ">
						<select class="custom-select setPaymentMethods" id="paymentMethod" required>
					...
					<div class="input-group ">
						<select class="custom-select setExpenseCategories" id="category" required>
					...
					<div class="row mx-0">
						<div class="col px-0">
							<button type="reset" class="btn btn-default mt-4 text-white"><i class="fas fa-times"></i> Anuluj</button>
						</div>
