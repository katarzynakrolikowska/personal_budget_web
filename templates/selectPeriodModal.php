    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title ml-4 text-gray" id="selectPeriodModalLabel">Wybierz zakres 
            ...
            <div class="modal-body">
                <form action="index.php?action=setBalance&period=customPeriod" method="post"> 
                    <div class="form-group row pr-5">
                        ...
                        <input type="date" class="form-control col-8 js-modal__input-start-date" id="dateStart" name="startDate">
                    </div>
                    
                    <div class="form-group row pr-5">	
                        <label class="col-form-label col-4 text-center" for="dateEnd">Do dnia</label>
                        <input type="date" class="form-control col-8 js-modal__input-end-date" id="dateEnd" placeholder="Data końcowa" name="endDate">
                    </div>
