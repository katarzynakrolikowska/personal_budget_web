    ...
    <div class="row mx-0">
        <div class="col-12 col-md-6 px-0">
            <img src="img/office-pen-calculator-computation-163032.jpeg" id="imgLeft">
        ...
        <div class="col-12 col-md-6 px-0">
            <img src="img/alone-bills-cash-1435192.jpg" id="imgRight">
    ...
    <div class="row pb-5 mx-0" id="startButtons">
